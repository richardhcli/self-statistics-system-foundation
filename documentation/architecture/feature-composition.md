...
1. **Isolation:** `features/developer-graph` maintains its own store.
2. **Consumption:** The component injected into a "Slot" retains access to its original feature store.
